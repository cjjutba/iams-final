...
- Attendance endpoint request/response contract changes.
- Status definitions and transitions changes.
- Uniqueness or dedup policy changes.
- Manual override audit requirements changes.
