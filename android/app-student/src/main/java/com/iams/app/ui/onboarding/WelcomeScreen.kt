...
fun WelcomeScreen(
    ...
    Column(
        ...
        Column(
            ...
            // Student button — after the 2026-04-22 two-app split the
            // Welcome screen is student-only. Faculty have their own APK
            // (com.iams.app.faculty) — see docs/plans/2026-04-22-two-app-split.
            IAMSButton(
                text = "Student Login",
                onClick = {
            ...
            Text(
                text = "Faculty? Install the separate IAMS Faculty app.",
