...
fun StudentLoginScreen(
    ...
    // Navigate on successful login. This APK is student-only after the
    // 2026-04-22 split — a faculty role here would indicate a misconfigured
    // VPS or a wrong-credential test; treat it as an error.
        ...
        if (uiState.loginSuccess) {
            if (uiState.userRole == "student") {
                ...
                toastState.showToast(
                    "This app is for students only. Install the IAMS Faculty app to sign in as faculty.",
                    ToastType.ERROR,
                )
                viewModel.clearError()
            }
